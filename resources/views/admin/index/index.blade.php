...
@section('content')
    ...
    <aside class="Hui-aside">
        ...
        <div class="menu_dropdown bk_2">
            ...
            <dl id="menu-article">
                <dt>轮播管理<i class="Hui-iconfont menu_dropdown-arrow">
                        &#xe6d5;</i>
                </dt>
                <dd>
                    <ul>
            ...
            <dl id="menu-article">
                <dt>图文管理<i class="Hui-iconfont menu_dropdown-arrow">
                        &#xe6d5;</i>
                </dt>
                <dd>
                    <ul>
                        <li><a data-href="{{ URL::asset('/admin/article/index') }}" data-title="图文管理"
                               href="javascript:void(0)">图文管理</a></li>
                        <li><a data-href="{{ URL::asset('/admin/article/recovery') }}" data-title="文章回收站"
                               href="javascript:void(0)">文章回收站</a></li>
                        {{--<li><a data-href="{{ URL::asset('/admin/showpic/index') }}" data-title="分享图片管理"--}}
                               {{--href="javascript:void(0)">分享图片管理</a></li>--}}
                    </ul>
                </dd>
            </dl>
            <dl id="menu-article">
                ...
                <dd>
                    <ul>
                        ...
                        {{--<li><a data-href="{{ URL::asset('/admin/guanzhu/index') }}" data-title="关注明细"--}}
                               {{--href="javascript:void(0)">关注明细</a></li>--}}
                    </ul>
                </dd>
            </dl>
