        ...
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    <input id="avatar" name="img" type="text" class="input-text" style="width:350px"
                           value="{{ isset($data->img) ? $data->img : URL::asset('/img/upload.png')}}"
                           placeholder="请输图片网络连接地址">
            ...
            <div class="row cl">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <input class="btn btn-primary radius" type="submit" value="保存图片">
...
//
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('admin/showpic/edit')}}",
